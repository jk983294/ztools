 ...
 */
char* CreateShm(const std::string& path, uint64_t size, int32_t magic, int32_t date, bool lock= false, bool reset = false);
char* LinkShm(const std::string& path, int32_t magic, int32_t date, bool isReadOnly);
/**
